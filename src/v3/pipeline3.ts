 ...
 * report can be reproduced or audited later: the window, the exact command,
 * and any project filter that was applied (which changes what was in scope —
 * see the note in extract2.ts).
 */
export interface RunMeta {
  ...
  command: string
  /** Project filters passed via --project, if any. Empty/undefined means all projects. */
  projectFilter?: string[]
  /** Distinct projects actually seen in the extracted window */
  projectsSeen: string[]
