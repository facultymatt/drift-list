...
- algo-recursion — recursive decomposition, base cases, termination, stack depth
- algo-traversal — depth-first vs breadth-first, visit order, early exit
- algo-complexity — time and space cost, short-circuiting, when it stops mattering
- data-structures — trees, graphs, cycles, choosing the shape of the data itself

## Cross-cutting

- defensive-design — input validation, guarding boundaries, what a library owes its callers
